import { Card, defaultCard, CardDeck, CardType } from "./cards";
//QNAs
...
export function getUpperLimit(deck: CardDeck): QuestionGeneratorSettings {
  return {
    SameCategory: false,
    MCQ: {
      noOfQuestion: deck.cards.length,
